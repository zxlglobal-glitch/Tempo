...
export default function Tempo() {
  ...
  const isAuth = path === '/login' || path === '/register'; const isEdit = path === '/profile/edit'; const isNew = path === '/workouts/new';
  ...
  const known = Boolean(workoutId) || path === '/' || isAuth || isEdit || isNew || Boolean(profileId);
